							...
							<div class="user-data full-width">
								<div class="user-profile">
									...
									<div class="user-specs" style="margin-top:20px;">
										...
										<span> at Nama Perusahaan</span>
									</div>
								</div>
								<!--user-profile end-->
								<ul class="user-fw-status">
									<li>
										<h4><a href="{{'/profile-following'}}">Following</a></h4>
										<span>34</span>
									</li>
									<li>
										<h4><a href="{{'/profile-follower'}}">Followers</a></h4>
										<span>155</span>
									</li>
									<li>
						...
						<div class="main-ws-sec">
							...
							<div class="posts-section">
								<div class="post-bar">
									...
									<div class="epi-sec">
										<ul class="descp">
											<li><img src="{{asset('mosaconnect/images/icon8.png')}}" alt=""><span>Epic Coder</span></li>
											<li><img src="{{asset('mosaconnect/images/icon9.png')}}" alt=""><span>Banda Aceh</span></li>
										</ul>
										<ul class="bk-links">
									...
									<div class="job-status-bar">
										<ul class="like-com">
											<li>
												...
												<img src="{{asset('mosaconnect/images/liked-img.png')}}" alt="">
												<span>25</span>
											</li>
											<li><a href="#" title="" class="com">
													<img src="{{asset('mosaconnect/images/com.png')}}" alt=""> Comment 15</a>
											</li>
										</ul>
								...
								<div class="post-bar">
									...
									<div class="epi-sec">
										<ul class="descp">
											...
											<li><img src="images/icon9.png" alt=""><span>Banda Aceh</span></li>
										</ul>
										<ul class="bk-links">
											<li><a href="#" title=""><i class="la la-bookmark"></i></a></li>
											<li><a href="#" title=""><i class="la la-envelope"></i></a></li>
